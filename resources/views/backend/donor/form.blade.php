<div class="mb-3">
    ...
    {!! Form::text('name', old('name', isset($donor) ? $donor->name : null), [
        'class' => 'form-control',
        'id' => 'name',
    ]) !!}
    @error('Name')
...
<div class="mb-3">
    ...
    {!! Form::email('email', old('email', isset($donor) ? $donor->email : null), [
        'class' => 'form-control',
        'id' => 'email',
    ]) !!}
    @error('Email')
...
<div class="mb-3">
    ...
    <input type="text" name="address" class="form-control " id="address"
        value="{{ old('address', isset($donor) ? $donor->address : null) }}">
...
<div class="mb-3">
    ...
    <input type="text" name="phone" class="form-control " id="phone"
        value="{{ old('address', isset($donor) ? $donor->phone : null) }}">
    {{-- Error Message --}}
    @error('phone')
        <div class="text-danger">{{ $message }}</div>
    @enderror
...
@unless(isset($donor))
    <div class="mb-3">
        ...
        <input type="number" name="quantity" class="form-control " id="quantity"
            value="{{ old('quantity', isset($donor) ? $donor->quantity_donated : null) }}" min="0" step="0.01">
        {{-- Error Message --}}
        @error('quantity')
            <div class="text-danger">{{ $message }}</div>
        @enderror
...
@unless(isset($donor))
    <div class="mb-3">
        ...
        {!! Form::select(
            'bloodbank',
            $userBloodBanks->pluck('name', 'id'),
            old('bloodbank', isset($donor) ? $userBloodBanks->pluck('id') : null),
            [
...
@unless(isset($donor))
    <div class="mb-3">
        ...
        <input type="date" name="date" class="form-control " id="date"
            value="{{ old('date', isset($donor) ? $donor->donation_date : null) }}">
        {{-- Optional text field for 'Other' --}}
        {{-- <input type="text" name="other_allergy_details" placeholder="Specify other allergy"> --}}
